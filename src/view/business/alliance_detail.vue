            ...
            <div class="panel">
                ...
                <div class="panel-body info-box">
                    <el-row :gutter=5>
                        ...
                        <el-col :span=20 class="bd">{{info.create_user_shop_account_name}}</el-col>
                    </el-row>
                    <el-row :gutter=5>
                        <el-col :span=4 class="hd">发布人职务：</el-col>
                        <el-col :span=20 class="bd">{{info.create_user_shop_account_melevel_name}}</el-col>
                    </el-row>
                    <el-row :gutter=5>
                        <el-col :span=4 class="hd">发布门店：</el-col>
                        <el-col :span=20 class="bd">{{info.create_user_shop_name}}</el-col>
                    </el-row>
                    <el-row :gutter=5>
            ...
            <div class="panel">
                ...
                <div class="panel-body info-box">
                    <el-row :gutter=5>
                        ...
                        <el-col :span=20 class="bd">{{info.user_info_user_name}}</el-col>
                    </el-row>
                    <el-row :gutter=5>
                        <el-col :span=4 class="hd">电话:</el-col>
                        <el-col :span=20 class="bd">{{info.user_info_user_phone}}</el-col>
                    </el-row>
                    <el-row :gutter=5>
                        <el-col :span=4 class="hd">出生日期:</el-col>
                        <el-col :span=20 class="bd">{{info.user_info_user_birth}}</el-col>
                    </el-row>
                    <el-row :gutter=5>
                        <el-col :span=4 class="hd">身高:</el-col>
                        <el-col :span=20 class="bd">{{info.user_info_user_height}}</el-col>
                    </el-row>
                    <el-row :gutter=5>
                        <el-col :span=4 class="hd">体重:</el-col>
                        <el-col :span=20 class="bd">{{info.user_info_user_weight}}</el-col>
                    </el-row>
                    <el-row :gutter=5>
                    ...
                    <el-row :gutter=5>
                        ...
                        <el-col :span=20 class="bd">{{info.user_info_skin}}</el-col>
                    </el-row>
                    <el-row :gutter=5>
                ...
                <div class="panel-body comment-panel">
                    <div class="comment-item">
                        <div class="comment-box">
                            <div class="hd mr-sm"><img src="https://fakeimg.pl/200x200/" width="40"  height="40" /></div>
                                <div class="bd">
                            ...
                            <div class="comment-item" v-for="(cm,index) in commentList" :key="cm._id">
                                <div class="comment-box">
                                    <div class="hd mr-sm"><img :src="cm.user_info_user_img" width="40"  height="40" /></div>
                                        <div class="bd">
                                            <div class="title f14"><span class="text-info">{{cm.user_info_user_name}}：</span><span></span>{{content}}</div>
                                    ...
                                    <div class="reply-box" v-if="cm.reply_status==1">
                                        <div class="title text-info f14">专家回复：</div>
                                        <div class="reply flex mt-sm">
                                            <div class="avatar mr-sm"><img :src="cm.reply_account_shop_account_img" width="30" height="30" /></div>
                                                <div class="body flex-sub">
