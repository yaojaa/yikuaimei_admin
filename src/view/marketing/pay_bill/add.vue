                        ...
                        <div class="table-body" v-for="item in ruleForm.rules.shakes" :key="item.index">
                            <div class="body-gift-choice body-item">
                                <div class="item-choice">
                                    <div class="choiced" v-if="item.coupon_code">已选中优惠券编号为{{item.coupon_code}}的优惠券</div>
                    ...
                    <div class="gift-table left0">
                        ...
                        <div class="table-body">
                            ...
                            <div class="comfort-right comfort-item">
                                <el-upload class="avatar-uploader" action="/api/admin/fileupload/image" :show-file-list="false" :on-success="show_default_img">
