...
<div class="tab-content">
             ...
             <div class="panel" v-if="activeTab == 'third'">
                ...
                <div class="daily-content">
                    ...
                    <div class="daily-item" v-for="(el,index) in daily" :key="el._id" >
                        ...
                        <div class="img_list">
                            <img v-for="(img,idx) in el.beauty_img" :src="img" width="200" height="300" />
                        </div>
   ...
   <el-tabs v-model="activeOrder" @tab-click="handleOrderClick">
    ...
    <el-tab-pane v-for="(order,idx) in refundList" :label="'退货单'+(idx+1)" :name="'refundOrder'+(idx+1)">
...
<h3>• 审核纪录</h3>
    ...
    <ul v-for="(log,index) in order.logs_list">
        <li>
