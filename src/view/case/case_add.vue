...
<!--上传ITEM end-->
  ...
  <!--上传ITEM start-->
   ...
   <el-form-item label="产品或仪器介绍">
       <el-input
        ...
        :rows="5"
        placeholder="请输入内容"
        v-model="form1.product_introduce.content">
      </el-input>
  </el-form-item>
  ...
  <div class="up_area">
    <el-upload
      multiple
      action="/api/admin/fileupload/image"
      :on-success  = "handleUploadSuccess_product_introduce"
      :on-remove="handleRemove_product_introduce"
      :show-file-list = false
      list-type="picture"
      >
  <el-button size="small" type="primary">+点击上传</el-button>
...
<!--上传ITEM end-->
  ...
  <div class="up_area">
    <el-upload
      ...
      action="/api/admin/fileupload/image"
      :show-file-list=false
      :on-success  = "handleUploadSuccess_operate_process"
      :on-remove="handleRemove_operate_process"
      list-type="picture"
            >
      <el-button size="small" type="primary">+点击上传</el-button>
    <div slot="tip" class="el-upload__tip">图片或者视频</div>
...
<!--上传ITEM end-->
  ...
  <div class="up_area">
    <el-upload
      ...
      list-type="picture"
      :show-file-list = false
      :on-success  = "handleUploadSuccess_operate_record"
      :on-remove="handleRemove_operate_record">
      <el-button size="small" type="primary">+点击上传</el-button>
    <div slot="tip" class="el-upload__tip">图片或者视频</div>
    </el-upload>
    <!---->
...
<!--上传ITEM end-->
  ...
  <!--上传ITEM start-->
   ...
   <el-form-item label="两次数据对比">
       <el-input
        ...
        :rows="5"
        placeholder="请输入内容"
        v-model="form1.data_contrast.content">
      </el-input>
  </el-form-item>
  ...
  <div class="up_area">
    <el-upload
      ...
      multiple
      action="/api/admin/fileupload/image"
      :on-success  = "handleUploadSuccess_data_contrast"
      list-type="picture"
      :show-file-list = false
      :on-remove="handleRemove_data_contrast">
    <el-button size="small" type="primary">+点击上传</el-button>
  <div slot="tip" class="el-upload__tip">图片或者视频</div>
    </el-upload>
...
<!--上传ITEM end-->
  ...
  <!--上传ITEM start-->
   ...
   <el-form-item label="专家解析">
       <el-input
        ...
        :rows="5"
        placeholder="请输入内容"
        v-model="form1.expert_analysis.content">
      </el-input>
  </el-form-item>
  ...
  <div class="up_area">
    <el-upload
      ...
      list-type="picture"
      :show-file-list = false  
      :on-success  = "handleUploadSuccess_expert_analysis"
      :on-remove="handleRemove_expert_analysis">
    <el-button size="small" type="primary">+点击上传</el-button>
  <div slot="tip" class="el-upload__tip">图片或者视频</div>
    </el-upload>
  ...
  <!--上传ITEM start-->
   ...
   <el-form-item label="点评师点评">
       <el-input
        ...
        :rows="5"
        placeholder="请输入内容"
        v-model="form1.expert_review.content">
      </el-input>
  </el-form-item>
  ...
  <div class="up_area">
    <el-upload
      ...
      action="/api/admin/fileupload/image"
          list-type="picture"
      :show-file-list = false
      :on-success  = "handleUploadSuccess_expert_review"
      :on-remove="handleRemove_expert_review">
   <el-button size="small" type="primary">+点击上传</el-button>
  <div slot="tip" class="el-upload__tip">图片或者视频</div>
    </el-upload>
