...
export default new Router({
  ...
  routes: [
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              meta: { title: '展会详情', permission: true }
            }
          ]
        },
        {
          ...
          children: [{
            ...
            meta: { title: 'app推送', permission: true }
          }, {
            path: 'sms',
            ...
            meta: { title: '站内信', permission: true }
          }, {
            path: 'chat',
    ...
    {
      path: '/showdetail',
      component: resolve => require(['../components/common/showdetail.vue'], resolve)
    },
    {
      path: '/404',
